...
<body>
    <header class="container text-center">
        <img src="imagens" alt="curl -o assets/images/sua-imagem-de-perfil.png https://avatars.githubusercontent.com/Ryan-Iago" class="rounded-circle" width="150" height="150"
            srcset="">
